...
var AweAccordion = (function () {
    ...
    AweAccordion.prototype.initialize = function () {
        ...
        jQuery('.ac-accordion__body:not(.ac-accordion__body .ac-accordion__body)', this.$el).hide().closest('.ac-accordion__panel').removeClass('active-content');
    };
        ...
        this.$el.delegate(".ac-accordion__header a:not(.ac-accordion__content .ac-accordion__header a)", fireEvent, function (event) {
            ...
            if (options.collapsible) {
                ...
                if (jQuery(this).hasClass("active")) {
                    ...
                    }).closest('.ac-accordion__panel').addClass('active-content');
                }
                else {
                    $statusIcon.removeClass(options.onOffIcon.expandIcon).addClass(options.onOffIcon.collapseIcon);
                    jQuery(".ac-accordion__body:first", $panel).stop().slideUp(options.duration).closest('.ac-accordion__panel').removeClass('active-content');
                }
            }
                ...
                jQuery(".ac-accordion__body:first", $activatedItem.parents(".ac-accordion__panel:first")).stop().slideUp(options.duration).closest('.ac-accordion__panel').removeClass('active-content');
