                        ...
                        <div class="main-content">
                            ...
                            <div class="form-wrap">
                                ...
                                <div class="form-wrap__inner">
                                    ...
                                    <!-- form-item -->
                                    <div class="form-item form-item--half">
                                        <label class="form__label">Building name<span>*</span>
                                        </label>
                                        <input class="form-control" type="text" name="input" placeholder="placeholder"/>
                                    </div><!-- End / form-item -->
                                    ...
                                    <!-- form-item -->
                                    <div class="form-item form-item--half">
                                        <label class="form__label">Block tower
                                        </label>
                                        <input class="form-control" type="text" name="input" placeholder="placeholder"/>
                                    </div><!-- End / form-item -->
                                    ...
                                    <!-- form-item -->
                                    <div class="form-item form-item--half">
                                        <label class="form__label">Floor<span>*</span>
                                        </label>
                                        <input class="form-control" type="text" name="input" placeholder="placeholder"/>
                                    </div><!-- End / form-item -->
                                    ...
                                    <!-- form-item -->
                                    <div class="form-item form-item--half">
                                        <label class="form__label">Room<span>*</span>
                                        </label>
                                        <input class="form-control" type="text" name="input" placeholder="placeholder"/>
                                    </div><!-- End / form-item -->
                            ...
                            <div class="form-wrap">
                                ...
                                <div class="form-wrap__inner">
                                    ...
                                    <div class="form-item form-item--split-3">
                                        <label class="form__label">Expiration date<span>*</span>
                                        </label>
                                        <input class="form-control" type="text" name="input" placeholder="mm"/>
                                    </div><!-- End / form-item -->
                                    ...
                                    <div class="form-item form-item--split-3">
                                        ...
                                        <input class="form-control" type="text" name="input" placeholder="yyy"/>
                                    </div><!-- End / form-item -->


                                    <!-- form-item -->
                                    <div class="form-item form-item--split-3 form-item-card">
                                        <label class="form__label">Security code<span>*</span>
                                        </label>
                                        <input class="form-control" type="text" name="input" placeholder="placeholder"/>
