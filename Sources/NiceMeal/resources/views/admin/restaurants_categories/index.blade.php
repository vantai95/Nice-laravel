    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
                {!! Form::open(['method' => 'GET', 'url' => '/admin/restaurants-categories', 'class' => ''])  !!}
                <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                            <a href="{{ url('/admin/restaurants-categories/create') }}"
                               class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                            <span>
                                <i class="la la-plus-circle"></i>
                                <span>
                                    @lang('admin.restaurants_categories.breadcrumbs.new_category')
                                </span>
                            </span>
                            </a>
                ...
                <table class="table table-striped table-bordered table-responsive-md">
                    ...
                    @foreach($categories as $key => $item)
                        <tr class="text-center">
                            @if($item->restaurants_categories_image)
                                <td class="align-middle"><img src="{{ url('images/uploads/'.$item->restaurants_categories_image) }}" class="img-circle img-fluid" alt=""></td>
                            @else
                                <td class="align-middle"><img src="{{ url('common-assets/img/category_default.png') }}" class="img-circle img-fluid" alt="category default" ></td>
                            @endif
                            ...
                            <td class="text-nowrap align-middle">
                                <a href="{{ url('/admin/restaurants-categories/' . $item->restaurants_categories_id . '/edit') }}"
                                ...
                                {!! Form::open([
                                   'method' => 'DELETE',
                                   'url' => ['/admin/restaurants-categories', $item->restaurants_categories_id],
