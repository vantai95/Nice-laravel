...
@section('content')
    ...
    <div class="m-content">
        ...
        <div class="row">
            <div class="col-lg-7">
            {!! Form::model($category, [ 'method' => 'PATCH', 'url' => ['/admin/'.$res->res_Slug.'/categories', $category->id],  'enctype' => 'multipart/form-data', 'novalidate'=>'novalidate', 'class' => 'category-form m-form m-form--fit m-form--label-align-right', 'id' => 'submitForm', 'files' => true]) !!}
