@php
    ...
    $inscrease = [trans('admin.time_base_pricing_rules.select.decrease') => 0,trans('admin.time_base_pricing_rules.select.increase') => 1];
@endphp
...
<div class="m-portlet__body m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
    ...
    <div class="form-group m-form__group row">
        <div class="col-lg-6 {{ $errors->has('name') ? 'has-error' : ''}}">
            <label for="name" class="col-form-label col-sm-12">@lang('admin.time_base_pricing_rules.columns.name')
    ...
    {{--Choose display type base on period--}}
    <div class="form-group m-form__group row" id="choose_date">
        <div class="col-lg-6 {{ $errors->has('period_type') ? 'has-error' : ''}}">
            <label for="period_type" class="col-form-label col-sm-12">@lang('admin.time_base_pricing_rules.columns.period_type')
                <span class="text-danger">*</span></label>
            <div class="col-sm-9">
    ...
    <div class="form-group m-form__group row period_specifice">
        <div class="col-lg-6 {{ $errors->has('from_date') ? 'has-error' : ''}}">
            <label class="col-form-label col-sm-12">@lang('admin.time_base_pricing_rules.columns.from_date')
                <span class="text-danger">*</span></label>
            <div class="col-lg-9 col-md-9 col-sm-12 ">
                <div class="input-group date">
                    {!! Form::text('from_date', isset($timeBasePricingRule) ? \Carbon\Carbon::parse($timeBasePricingRule->from_date)->format('Y-m-d'):\Carbon\Carbon::now()->format('Y-m-d'), ['class' => 'form-control m-input','id' => 'from_date','readonly' => 'true']) !!}
        ...
        <div class="col-lg-6 {{ $errors->has('to_date') ? 'has-error' : ''}}">
            <label class="col-form-label col-sm-12">@lang('admin.time_base_pricing_rules.columns.to_date')
                <span class="text-danger">*</span></label>
            <div class="col-lg-9 col-md-9 col-sm-12 ">
                <div class="input-group date">
                    {!! Form::text('to_date', isset($timeBasePricingRule) ? \Carbon\Carbon::parse($timeBasePricingRule->to_date)->format('Y-m-d'):\Carbon\Carbon::now()->format('Y-m-d'), ['class' => 'form-control m-input','id' => 'to_date','readonly' => 'true']) !!}
                    <div class="input-group-append">
                        <span class="input-group-text">
                            <i class="la la-calendar-check-o"></i>
                        </span>
    ...
    <div class="form-group m-form__group row" id="all_day_section">
        <div class="col-lg-6 {{ $errors->has('all_days') ? 'has-error' : ''}}">
            <label for="period_type" class="col-form-label col-sm-12">@lang('admin.time_base_pricing_rules.columns.all_days')
                <span class="text-danger">*</span></label>
            <div class="col-sm-9">
    ...
    <div class="form-group m-form__group row" id="specific_date">
            ...
            <div class="col-sm-12">
                <div class="m-checkbox-inline">
                    <label class="m-checkbox">
                        {!! Form::checkbox('mon', 1, isset($timeBasePricingRule) ? $timeBasePricingRule->mon : false, ['class' => 'form-control ', 'name'=>'mon', 'id'=>'mon']) !!}
                        @lang('admin.time_base_pricing_rules.columns.mon')
                        <span></span>
                    </label>
                </div>
            </div>
        ...
        <div class="col-lg-4 {{ $errors->has('tue') ? 'has-error' : ''}}">
            <div class="col-sm-12">
                <div class="m-checkbox-inline">
                    <label class="m-checkbox">
                        {!! Form::checkbox('tue', 1, isset($timeBasePricingRule) ? $timeBasePricingRule->tue : false, ['class' => 'form-control ', 'name'=>'tue', 'id'=>'tue']) !!}
                        @lang('admin.time_base_pricing_rules.columns.tue')
                        <span></span>
                    </label>
                </div>
            </div>
        ...
        <div class="col-lg-4 {{ $errors->has('wed') ? 'has-error' : ''}}">
            <div class="col-sm-12">
                <div class="m-checkbox-inline">
                    <label class="m-checkbox">
                        {!! Form::checkbox('wed', 1, isset($timeBasePricingRule) ? $timeBasePricingRule->wed : false, ['class' => 'form-control ', 'name'=>'wed', 'id'=>'wed']) !!}
                        @lang('admin.time_base_pricing_rules.columns.wed')
                        <span></span>
                    </label>
                </div>
            </div>
        ...
        <div class="col-lg-4 {{ $errors->has('thu') ? 'has-error' : ''}}">
            <div class="col-sm-12">
                <div class="m-checkbox-inline">
                    <label class="m-checkbox">
                        {!! Form::checkbox('thu', 1, isset($timeBasePricingRule) ? $timeBasePricingRule->thu : false, ['class' => 'form-control ', 'name'=>'thu', 'id'=>'thu']) !!}
                        @lang('admin.time_base_pricing_rules.columns.thu')
                        <span></span>
                    </label>
                </div>
            </div>
        ...
        <div class="col-lg-4 {{ $errors->has('fri') ? 'has-error' : ''}}">
            <div class="col-sm-12">
                <div class="m-checkbox-inline">
                    <label class="m-checkbox">
                        {!! Form::checkbox('fri', 1, isset($timeBasePricingRule) ? $timeBasePricingRule->fri : false, ['class' => 'form-control ', 'name'=>'fri', 'id'=>'fri']) !!}
                        @lang('admin.time_base_pricing_rules.columns.fri')
                        <span></span>
                    </label>
                </div>
            </div>
        ...
        <div class="col-lg-4 {{ $errors->has('sat') ? 'has-error' : ''}}">
            <div class="col-sm-12">
                <div class="m-checkbox-inline">
                    <label class="m-checkbox">
                        {!! Form::checkbox('sat', 1, isset($timeBasePricingRule) ? $timeBasePricingRule->sat : false, ['class' => 'form-control ', 'name'=>'sat', 'id'=>'sat']) !!}
                        @lang('admin.time_base_pricing_rules.columns.sat')
                        <span></span>
                    </label>
                </div>
            </div>
        ...
        <div class="col-lg-4 {{ $errors->has('sun') ? 'has-error' : ''}}">
            <div class="col-sm-12">
                <div class="m-checkbox-inline">
                    <label class="m-checkbox">
                        {!! Form::checkbox('sun', 1, isset($timeBasePricingRule) ? $timeBasePricingRule->sun : false, ['class' => 'form-control ', 'name'=>'sun', 'id'=>'sun']) !!}
                        @lang('admin.time_base_pricing_rules.columns.sun')
                        <span></span>
                    </label>
                </div>
            </div>
        ...
        <div class="col-lg-12 validate-message" id="validate_message">
            <p class="help-block field-error">@lang('admin.time_base_pricing_rules.validation_message.at_least_one')</p>
        </div>
    </div>
    ...
    <div class="form-group m-form__group row">
        <div class="col-lg-6 {{ $errors->has('all_times') ? 'has-error' : ''}}">
            <label for="period_type" class="col-form-label col-sm-12">@lang('admin.time_base_pricing_rules.columns.all_times')
                <span class="text-danger">*</span></label>
            <div class="col-sm-9">
    ...
    <div class="form-group m-form__group row" id="specific_time">
        <div class="col-lg-6 {{ $errors->has('from_time') ? 'has-error' : ''}}">
            <label for="from_time" class="col-form-label col-sm-12">@lang('admin.time_base_pricing_rules.columns.from_time')
                <span class="text-danger">*</span></label>
            <div class="col-lg-9 col-md-9 col-sm-12">
                {!! Form::text('from_time',null, ['class' => 'form-control','id' => 'from_time']) !!}
                {!! $errors->first('from_time', '<p class="help-block field-error">:message</p>') !!}
            </div>
        </div>
        <div class="col-lg-6 {{ $errors->has('to_time') ? 'has-error' : ''}}">
            <label for="to_time" class="col-form-label col-sm-12">@lang('admin.time_base_pricing_rules.columns.to_time')
                <span class="text-danger">*</span></label>
            <div class="col-lg-9 col-md-9 col-sm-12">
                {!! Form::text('to_time',null, ['class' => 'form-control','id' => 'to_time']) !!}
    ...
    {{--Display Inscrease--}}
    {{--<div class="form-group m-form__group row">--}}
        {{--<div class="col-lg-6 {{ $errors->has('inscrease') ? 'has-error' : ''}}">--}}
            {{--<label for="inscrease" class="col-form-label col-sm-12">@lang('admin.time_base_pricing_rules.columns.inscrease')--}}
                {{--<span class="text-danger">*</span></label>--}}
            {{--<div class="col-sm-9">--}}
                {{--{!! Form::select('inscrease', array_keys($inscrease) ,isset($timeBasePricingRule) ? $timeBasePricingRule->inscrease : null,['class' => 'form-control m-input','id' => 'inscrease'])!!}--}}
            {{--</div>--}}
            {{--{!! $errors->first('inscrease', '<p class="help-block field-error">:message</p>') !!}--}}
        {{--</div>--}}

    {{--</div>--}}

    <div class="form-group m-form__group row">
        <div class="col-lg-6 {{ $errors->has('value') ? 'has-error' : ''}}">
            <label for="value" class="col-form-label col-sm-12">@lang('admin.time_base_pricing_rules.columns.value')
                <span class="text-danger">*</span></label>
            <div class="col-sm-9">
                {!! Form::text('value', null, ['class' => 'form-control m-input','onkeypress' => 'return isNumber(event)','id' => 'value']) !!}
    ...
    <div class="form-group m-form__group row">
        <div class="col-lg-4 {{ $errors->has('active') ? 'has-error' : ''}}">
            <div class="col-sm-12">
                <div class="m-checkbox-inline">
                    <label class="m-checkbox">
                        {!! Form::checkbox('active', 1, isset($timeBasePricingRule) ? $timeBasePricingRule->active : true, ['class' => 'form-control ', 'name'=>'active', 'id'=>'active']) !!}
                        @lang('admin.time_base_pricing_rules.columns.active')
                        <span></span>
                    </label>
                </div>
            </div>
        ...
        $(document).ready(function () {
            ...
            $('#period_type').change(function () {
                if ($('#period_type').val() == '1') {
                    ...
                    $('.period_specifice').find('input[type=text]').each(function (index) {
                        $(this).val('');
                    })
                }
            });
            ...
            $('#all_times').change(function () {
                if ($('#all_times').val() == '0') {
                    ...
                    $('#specific_time').hide();
                    $('#specific_time').find('input[type=text]').each(function (index) {
                        $(this).val('');
                    })
                }
            });
