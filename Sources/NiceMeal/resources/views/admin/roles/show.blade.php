                    ...
                    <div class="tab-content">
                        <div class="m-portlet__body">
                            <div class="row row-eq-height">
                                ...
                                <div class="col-md-3">
                                    <span class="role-content-title">@lang('admin.roles.title.news_types')</span>
                                    <ul class="list-group pt-list-5">
                                        <li class="list-group-item role-content-list">
                                            <i class="fa {{App\Services\CommonService::containString($role->permissions,'et1') ? 'fa-check-circle check-icon'  : 'fa-circle-o'}}"></i> @lang('admin.roles.checkbox_title.news_types_view')
                                        </li>
                                        <li class="list-group-item role-content-list">
                                            <i class="fa {{App\Services\CommonService::containString($role->permissions,'et2') ? 'fa-check-circle check-icon'  : 'fa-circle-o'}}"></i> @lang('admin.roles.checkbox_title.news_types_manage')
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-md-3">
