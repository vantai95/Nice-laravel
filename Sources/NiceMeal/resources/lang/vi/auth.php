...
return [
    ...
    */
    ...
    'register' => [
        ...
        'email' => 'Địa Chỉ Email',
        'button' => 'Đăng Ký',
        'validate_full_name' => 'Tên không được phép có kí tự đặc biệt hoặc số'
    ],
    'login' => [
        'title' => 'Đăng Nhập',
        'email' => 'Địa Chỉ E-Mail',
        'password' => "Mật Khẩu",
        'remember_me' => 'Nhớ Trên Máy Tính',
    ...
    'email' => [
        'title' => 'Lấy Lại Mật Khẩu',
        'email' => 'Địa Chỉ E-Mail',
        'button' => 'Gửi Đường Dẫn Lấy Lại Mật Khẩu'
    ],
    'socialite' => [
    ...
    'flash_message' => [
        ...
        'failed' => 'Bạn không có quyền truy cập vào trang này!',
        'banned_error' => 'Tài khoản bị cấm vĩnh viễn! Nếu bạn muốn tiếp tục, vui lòng liên hệ với người quản trị.',
        'locked_error' => 'Tài khoản bị khóa tạm thời! Nếu bạn muốn tiếp tục, vui lòng liên hệ với người quản trị.'
    ]
];
