...
class FaqsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $faqTypeId = $request['faq-type'];
        if($faqTypeId) {
            $faqs = Faq::select('faqs.*' )->where('faq_type_id',$faqTypeId)->orderBy('faqs.id', 'desc');
        }
        if (!empty($keyword)) {
    ...
    public function create()
    {
        ...
        $faqType = FaqType::get();
        return view('admin.faq.create', compact( 'breadcrumbs','faqType'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $requestData['faq_type_id'] = isset($requestData['faq_type_id']) ? implode(' ',$requestData['faq_type_id']) : "";
    ...
    public function edit($id)
    {
        ...
        $faqType = FaqType::get();
        return view('admin.faq.edit', compact('faq','faqId', 'breadcrumbs','faqType'));
    }
